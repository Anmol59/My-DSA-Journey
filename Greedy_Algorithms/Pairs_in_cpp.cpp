...
int main(){
    ...
    //for creating pairs we use (pair) keyword and in angular brackets tell data types
    ...
    sort(activity.begin(),activity.end(),compare); //sort on the time of end (parameter)
